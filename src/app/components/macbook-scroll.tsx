...
import AWS1 from "../../../public/images/AWS_1.jpg";
...
export default function MacbookScroll({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[250vh] pt-20 pb-40 flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
      ...
      >
        {title || (
          <span>
            Weekly Meetings & Workshops <br />
            To help you break into tech
          </span>
        )}
      </motion.h2>
      {/* Lid */}
